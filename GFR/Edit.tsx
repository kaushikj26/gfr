                    ...
                    <Form onSubmit={handleSubmit}>
                        <Grid container rowSpacing={1} style={{ padding: 10 }} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                            <Grid item xs={12} md={6}><FormControl fullWidth>
                                ...
                                <Select label="Select crop category"
                                    error={touched.category && errors.category ? true : false} name='category' value={values.category} onChange={handleChange} onBlur={handleBlur}>
                            ...
                            <Grid item xs={12} md={6}><FormControl fullWidth>
                                ...
                                <Select label="Select Crop Season" error={touched.season && errors.season ? true : false} name='season' value={values.season} onChange={handleChange} onBlur={handleBlur}>
                                    <MenuItem value=""><em>None</em></MenuItem>
                                </Select>
                        ...
                        <Grid container rowSpacing={1} style={{ padding: 10 }} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                            ...
                            {/* <h2>Nitrogen</h2> */}
                               ...
                               <Grid item xs={12} md={6}><TextField id="outlined-basic"fullWidth  label="Nitrogen Very Low Value" variant="outlined" error={touched.nv2 && errors.nv2 ? true : false} name='nv2' value={values.nv3} onChange={handleChange} onBlur={handleBlur} helperText={touched.nv3 && errors.nv3} /></Grid>
                               <Grid item xs={12} md={6}><TextField id="outlined-basic"fullWidth  label="Nitrogen Very Low Value" variant="outlined" error={touched.nv2 && errors.nv2 ? true : false} name='nv2' value={values.nv4} onChange={handleChange} onBlur={handleBlur} helperText={touched.nv4 && errors.nv4} /></Grid>
                               <Grid item xs={12} md={6}><TextField id="outlined-basic"fullWidth  label="Nitrogen Very Low Value" variant="outlined" error={touched.nv2 && errors.nv2 ? true : false} name='nv2' value={values.nv5} onChange={handleChange} onBlur={handleBlur} helperText={touched.nv5 && errors.nv5} /></Grid>
                               {/* <h2>K2O</h2> */}
                               <Grid item xs={12} md={6}><TextField id="outlined-basic"fullWidth  label="K2O Low Value" variant="outlined" error={touched.kv2 && errors.kv2 ? true : false} name='kv2' value={values.kv2} onChange={handleChange} onBlur={handleBlur} helperText={touched.kv2 && errors.kv2} /></Grid>
                               ...
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="K2O Low Value" variant="outlined" error={touched.kv4 && errors.kv4 ? true : false} name='kv4' value={values.kv4} onChange={handleChange} onBlur={handleBlur} helperText={touched.kv4 && errors.kv4} /></Grid>
                                <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="K2O Low Value" variant="outlined" error={touched.kv5 && errors.kv5 ? true : false} name='kv5' value={values.kv5} onChange={handleChange} onBlur={handleBlur} helperText={touched.kv5 && errors.kv5} /></Grid>

                                {/* <h2>FYM/Compost</h2> */}
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="FYM/Compost High Value" variant="outlined" error={touched.cv2 && errors.cv2 ? true : false} name='cv2' value={values.cv2} onChange={handleChange} onBlur={handleBlur} helperText={touched.cv2 && errors.cv2} /></Grid>
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="FYM/Compost High Value" variant="outlined" error={touched.cv3 && errors.cv3 ? true : false} name='cv3' value={values.cv3} onChange={handleChange} onBlur={handleBlur} helperText={touched.cv3 && errors.cv3} /></Grid>
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="FYM/Compost High Value" variant="outlined" error={touched.cv4 && errors.cv4 ? true : false} name='cv4' value={values.cv4} onChange={handleChange} onBlur={handleBlur} helperText={touched.cv4 && errors.cv4} /></Grid>
                                ...
                                {/* <h2>Phosphorus</h2> */}
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="Phosphorus Very High Value" variant="outlined" error={touched.pv2 && errors.pv2 ? true : false} name='pv2' value={values.pv2} onChange={handleChange} onBlur={handleBlur} helperText={touched.pv2 && errors.pv2} /></Grid>
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="Phosphorus Very High Value" variant="outlined" error={touched.pv5 && errors.pv5 ? true : false} name='pv3' value={values.pv3} onChange={handleChange} onBlur={handleBlur} helperText={touched.pv3 && errors.pv3}/></Grid>
                               <Grid item xs={12} md={6}><TextField id="outlined-basic" fullWidth label="Phosphorus Very High Value" variant="outlined" error={touched.kv5 && errors.kv5 ? true : false} name='pv4' value={values.pv4} onChange={handleChange} onBlur={handleBlur} helperText={touched.pv4 && errors.pv4} /></Grid>
